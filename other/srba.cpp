...
int main(int argc, char**argv) {
	...
	SRBA rba;	 //  Create an empty RBA problem
	...
	rba.parameters.sensor.camera_calib.rightCameraPose.fromString("[0.12 0 0  0 0 0 0]");  // [X Y Z qr qx qy qz]
	...
	// --------------------------------------------------------------------------------
	SRBA::new_kf_observations_t  list_obs;
	SRBA::new_kf_observation_t   obs_field;
	...
	// --------------------------------------------------------------------------------
	SRBA::TOpenGLRepresentationOptions  opengl_options;
